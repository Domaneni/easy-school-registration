...
class ESRRegistrationValidationRegistrationTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_get_courses_data() {
        ...
        $this->assertEquals([
            0 => ESR()->course->get_course_data($course2_id),
            1 => ESR()->course->get_course_data($course_id)
        ], ESR()->course->get_courses_data_by_wave($wave_id));
    }
    ...
    public function test_set_course_passed() {
        ...
        $this->assertEquals(1, $worker_ajax->change_course_passed($course_id, true));
        ...
        $this->assertEquals(1, $worker_ajax->change_course_passed($course_id, false));
        ...
        $this->assertEquals(1, $worker_ajax->change_course_passed($course_id, true));
        $this->assertEquals(1, $worker_ajax->change_course_passed($course2_id, true));
