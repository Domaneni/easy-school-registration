...
/******/ ({
    ...
    class Edit extends Component {
      ...
      render() {
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "strong",
                  null,
                  "Easy School Registration - Registration"
                )
              )
            ),
        ...
        return [controls, React.createElement(ServerSideRender, {
          key: "course_registrations_preview",
          block: "easy-school-registration/registration",
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    registerBlockType("easy-school-registration/registration", {

      title: __("ESR Registration", "easy-school-registration"),
      description: __("Select a wave below to add registration to your page.", "easy-school-registration"),
      category: "embed",
      supports: {
      ...
      keywords: ["easy school registration", "esr", "registration"],
      attributes: {
        waveId: {
          type: "string"
        },
